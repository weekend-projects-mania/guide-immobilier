...
const verifierResources = [
  { name: "Interne — données BCE, BNB, ONSS, SPF Finances", url: "/verifier-entreprise", description: "Vérifier une entreprise en un clic (statut, forme juridique, dettes, actes - sources officielles)", addedAt: "2026-08-14", highlight: true },
