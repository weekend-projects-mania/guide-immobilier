...
const searchableItems = [
  ...
  { name: "Wallex - Juridique Wallonie", url: "https://wallex.wallonie.be/home.html", category: "Rechercher" },
  { name: "Vlaamse Codex - Juridique Flandre", url: "https://codex.vlaanderen.be/", category: "Rechercher" },
  // Ressources
  ...
  { name: "Les Apéros Immo - WhatsApp", url: "https://chat.whatsapp.com/EyenGIkAV0yHVuE5iPWCWF", category: "Médias - Communautés" },
  { name: "Immo Passion - WhatsApp", url: "https://chat.whatsapp.com/BYwpls3CXIbKPlWUSwAPkc", category: "Médias - Communautés" },
  { name: "PIM.be - Forum", url: "https://forum.pim.be/", category: "Médias - Communautés" },
...
const SearchBar = () => {
  ...
  return (
    <div ref={searchRef} className="container px-4 mb-4">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-9 h-10 bg-white dark:bg-black border-black dark:border-white text-black dark:text-white placeholder:text-muted-foreground rounded-full text-sm w-full"
        />
